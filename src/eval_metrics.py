...
def eval_iemocap_test(results, truths, single=-1):
    emos = ["Neutral", "Happy", "Sad", "Angry"]
    metrics = {}
    ...
    if single < 0:
        ...
        for emo_ind in range(4):
            ...
            metrics[emos[emo_ind]] = {
                "accuracy": accuracy_score(test_truth_i, test_preds_i),
                "precision": precision_score(test_truth_i, test_preds_i, average='weighted'),
                "recall": recall_score(test_truth_i, test_preds_i, average='weighted'),
                "f1": f1_score(test_truth_i, test_preds_i, average='weighted'),
                "auc": roc_auc_score(test_truth_i, test_preds_i, average='weighted')
            }
